...
public class BasketTest {
    ...
    void consolidateBasketTest() {
        ...
        basket.add("productCode", "myProduct", 10);
        basket.add("productCode", "myProduct", 10);
        basket.add("productCode1", "myProduct1", 15);
        ...
        assertEquals(basketSize.size(),2);
        assertEquals(basketSize.get(0).getProductCode(), "productCode");
        assertEquals(basketSize.get(0).getQuantity(), 30);
        assertEquals(basketSize.get(1).getProductCode(), "productCode1");
        assertEquals(basketSize.get(1).getQuantity(), 15);
    }
}
